<?php session_start(); // Session 启动！！！！
		if(!isset($_SESSION['userid'])||$_SESSION['userqx']<>2){ // 要不要判断 ID 是否存在于系统数据库中？？？---  2015 08 24  中午
  ...
  <frameset rows="18%,77%,*"  frameborder="1" border="1" framespacing="0" bordercolor="4682B4">
    <frame name="topFrame" src="topindex.html" scrolling="no"  noresize="noresize" marginwidth="0" />
	  <frameset id="mainFrameset" cols="12%,*" framespacing="2" frameborder="1"   border="1" framespacing="0"  >
	    <frame name="leftFrame" src="leftCounselor.php" scrolling="no" noresize="noresize" scrolling="auto" />
