...
{	border:1px solid #4169E1;
 ...
 <div id="top2" style="width:100%;height:4%;">
   		<div id="top21" style="float:left;width:60%;height:5px;">
   		<span style="text-align:left;FONT-SIZE:13px;"><font color="#4B0082">用户名: <?php echo $sessionName;?></font></span>
   		</span>
  		</div>	
		<div id="top22" style="float:right;width:6%;height:30px;">
   		<span style="text-align: right;"><input type="button" name="rebackBtn" id="rebackBtn" style="border-width:0px;FONT-SIZE:12px;FONT-FAMILY:"宋体","Verdana";width:50px;height:30px;font-size:14px;BACKGROUND-COLOR:#FFFFFF;" value="注销" onclick="logoutBtnClick()" >
		</span>
   		</div>
   	</div>
